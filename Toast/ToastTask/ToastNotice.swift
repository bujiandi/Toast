    ...
    internal static var rootView:NoticeView {
        guard let view = _rootView else {
            ...
            view.contentView.addConstraints([
                line.anchor.leading    == view.contentView.anchor.leading,
                line.anchor.trailing   == view.contentView.anchor.trailing,
                line.anchor.bottom     == view.contentView.anchor.bottom,
                line.anchor.height     == Toast.onePixel,
                down.anchor.centerX    == view.contentView.anchor.centerX     && .levelHigh,
                down.anchor.bottom     == view.contentView.anchor.bottom - 9  && .levelHigh,
                down.anchor.height     == height && .levelHigh,
                down.anchor.width      == width  && .levelHigh
                ])
