...
internal class AnimationBasic<T, Value> where T : CAAnimation {
    
    internal let caAnimation:T
    
    internal init(_ caAnimation:T) {
    ...
    @discardableResult
    internal func delay(_ value:TimeInterval) -> Self {
    ...
    @discardableResult
    internal func timingFunction(_ value:CAMediaTimingFunction) -> Self {
    ...
    @discardableResult
    internal func removedOnCompletion(_ value:Bool) -> Self {
        caAnimation.isRemovedOnCompletion = value
        return self
    }
    
    @discardableResult
    internal func onStoped(_ completion: @escaping @convention(block) (Bool) -> Void) -> Self {
    ...
    @discardableResult
    internal func onDidStart(_ started: @escaping @convention(block) () -> Void) -> Self {
        if let delegate = caAnimation.delegate as? AnimationDelegate {
     ...
     * Defaults to 1. */
    @discardableResult
    internal func speed(_ value:Float) -> Self {
    ...
    @discardableResult
    internal func time(offset:CFTimeInterval) -> Self {
    ...
    @discardableResult
    internal func `repeat`(count:Float) -> Self {
    ...
    @discardableResult
    internal func `repeat`(duration:CFTimeInterval) -> Self {
     ...
     * to NO. */
    @discardableResult
    internal func autoreverses(_ value:Bool) -> Self {
     ...
     * `removed'. */
    @discardableResult
    internal func fill(mode:AnimationFillMode) -> Self {
