...
extension CALayer {
    ...
    internal func animate(transition style:TransitionStyle, from direction:TransitionDirection) {
    ...
    /// 摇晃动画
    internal func animateShake(count:Float = 3) {
    ...
    /// 震荡动画
    internal func animateShock(count:Float = 2) {
