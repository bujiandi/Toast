...
internal enum AnimationFillMode : String {
    case backwards
    case forwards
    case both
    case removed
...
internal final class Animation<T, Value> : AnimationBasic<T, Value> where T : CAAnimation {
...
//    }
     ...
     * NO. */
    @discardableResult
    internal func additive(_ value:Bool) -> Self {
    ...
    @discardableResult
    internal func cumulative(_ value:Bool) -> Self {
    ...
    @discardableResult
    internal func valueFunction(_ value:CAValueFunction) -> Self {
...
//    }
    ...
    @discardableResult
    internal func from(_ value:Value) -> Self {
        caAnimation.fromValue = value
        return self
    }
    
    @discardableResult
    internal func to(_ value:Value) -> Self {
    ...
    @discardableResult
    internal func by(_ value:Value) -> Self {
...
extension Animation where T : CASpringAnimation {
    ...
    @available(iOS 9.0, *)
    @discardableResult
    internal func mass(_ value:CGFloat) -> Self {
    ...
    @available(iOS 9.0, *)
    @discardableResult
    internal func stiffness(_ value:CGFloat) -> Self {
    ...
    @available(iOS 9.0, *)
    @discardableResult
    internal func damping(_ value:CGFloat) -> Self {
    ...
    @available(iOS 9.0, *)
    @discardableResult
    internal func initialVelocity(_ value:CGFloat) -> Self {
