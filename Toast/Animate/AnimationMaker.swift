...
internal class AnimationMaker<Layer, Value> where Layer : CALayer {
    internal unowned let maker:AnimationsMaker<Layer>
    internal let keyPath:String
    internal init(maker:AnimationsMaker<Layer>, keyPath:String) {
        self.maker = maker
...
internal class UnknowMaker<Layer, Value> where Layer : CALayer {
    internal unowned let maker:AnimationsMaker<Layer>
    internal let keyPath:String
    internal init(maker:AnimationsMaker<Layer>, keyPath:String) {
        self.maker = maker
